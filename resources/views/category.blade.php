                    ...
                    <div class="filter_container">
                        ...
                        <div class="filter_items">
                            ...
                            <div class="select_item">
                                <select class="select_menu">
                                    ...
                                    <option value="2">Epoksid boyaları</option>
                                    <option value="3">Poliretan boyaları</option>
                                    <option value="4">Sellülozik boyaları</option>
                                </select>
                                <select class="select_menu">
                                    <option value="0">Bütün məhsullar</option>
                                    <option value="1">Sənaye boyaları</option>
                        ...
                        <div class="filter_items drop_filter_item">
                            ...
                            <div class="filter_check_items">
                                ...
                                <label class="f_check_type">
                                    <input type="checkbox" name=packaging" value="1" checked>
                                    <span>7.5 Kq</span>
                                </label>
                                <label class="f_check_type">
                                    <input type="checkbox" name=packaging" value="1">
...
<script>
    $(document).ready(function () {
        ...
        $('#country').select2({
            dropdownParent: $('.customDrop-country')
        });
        $('#month').select2({
            //hide search field
            minimumResultsForSearch: Infinity,
            dropdownParent: $('.customDrop-month')
        });
    });
</script>
@push('js')
