    ...
    <div class="section_wrap wrap_sign_items ">
        ...
        <div class="section_wrap wrap_sign_content ">
            ...
            <form action="#" method="post">
                <div class="form_item ">
                    <input type="text" name="fullname" placeholder="Ad, Soyad" value="" class="item_input" >
                ...
                <div class="security_content">
                    Siz davam et düyməsini sıxmaqla <a href="#">İstifadəçi şərtlərini</a> və <a href="#">Məxfilik siyasətini</a> qəbul etmiş olursunuz.
                </div>
                <div class="form_item">
                    <button type="submit" class="btn_sign submit_btn">Qeydiyyatdan keç </button>
                </div>
                <div class="form_item">
                    <button type="submit" class="btn_sign link_btn">Daxil ol</button>
                </div>
            </form>
