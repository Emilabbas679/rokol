                        ...
                        <div class="basket_items">
                            ...
                            <div class="basket_item_content">
                                <div class="bsk_row_list">
                                    <p class="itm_title">Rokol sintetik paralaq boya </p>
                                    <div class="bsk_icons">
                                ...
                                <div class="bsk_row_list">
                                    <span class="bck_itm_name">Rəngi:</span>
                                    <span class="bck_itm_val">Qırmızı</span>
                                </div>
                                <div class="bsk_row_list">
                                    <span class="bck_itm_name">Çəkisi:</span>
                                    <span class="bck_itm_val">7.5 kq</span>
                                </div>
                                <div class="bsk_row_list">
